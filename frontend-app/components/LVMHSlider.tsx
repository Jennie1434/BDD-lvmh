...
export function LVMHSlider() {
    ...
    useEffect(() => {
        ...
        const initApplication = async () => {
            ...
            const SLIDER_CONFIG: any = {
                settings: {
                    transitionDuration: 2.5, autoSlideSpeed: 3000, currentEffect: "glass", currentEffectPreset: "Default",
            ...
            const slides = [
                { title: "Leather Excellence", media: "/assets/slide1.png" },
                { title: "Prestige Bubbles", media: "/assets/slide2.png" },
                { title: "Horological Art", media: "/assets/slide3.png" },
                { title: "Scented Dreams", media: "/assets/slide4.png" },
                { title: "Radiant Light", media: "/assets/slide5.png" }
            ];
        ...
        `;
            ...
            const handleSlideChange = () => { if (isTransitioning || !texturesLoaded || !sliderEnabled) return; navigateToSlide((currentSlideIndex + 1) % slides.length); };
            ...
            const createSlidesNavigation = () => {
                ...
                slides.forEach((slide, i) => {
                    ...
                    item.addEventListener("click", () => { if (!isTransitioning && i !== currentSlideIndex) navigateToSlide(i); });
    ...
    return (
        <>
            <main className="slider-wrapper h-screen">
