...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F7F4F1] text-[#1A1A1A]">
            <Head>
                <title>LVMH - Connexion</title>
                <meta name="description" content="Login access to LVMH cockpit." />
            </Head>
            ...
            <div className="min-h-screen flex">
                <div className="hidden lg:flex w-1/2 p-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Connectez-vous pour acceder a l interface et gerer les clients,
                            les transcriptions et les analyses en temps reel.
                        </p>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                    ...
                    >
                        <div className="mb-8">
                            <p className="text-xs uppercase tracking-[0.3em] text-gray-400">Connexion</p>
                            <h2 className="text-2xl font-serif font-bold mt-2">Bienvenue</h2>
                        </div>
